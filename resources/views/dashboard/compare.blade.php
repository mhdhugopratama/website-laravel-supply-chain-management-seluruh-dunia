...
<div class="container-fluid px-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="nb-card text-center" style="padding: 14px;">
        ...
        <div class="col-6 col-md-3">
            <div class="nb-card text-center" style="padding: 14px;">
                ...
                <div style="font-size:1.6rem; font-weight:900; color:var(--text-dark); margin-top:4px;">{{ $countryA->currency_symbol ?? $countryA->currency_code }}</div>
                <div style="font-size:0.65rem; color:var(--text-muted);">Currency A</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="nb-card text-center" style="padding: 14px;">
                ...
                <div style="font-size:1.6rem; font-weight:900; color:var(--text-dark); margin-top:4px;">{{ $countryB->currency_symbol ?? $countryB->currency_code }}</div>
                <div style="font-size:0.65rem; color:var(--text-muted);">Currency B</div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
                ...
                <div class="nb-card-body">
                    <div class="row g-3">
                        <div class="col-12 col-md-6" style="border-right: 1px solid var(--card-border);">
                            ...
                            <div style="background: rgba(255,255,255,0.02); padding: 12px; border-radius: 8px; border: 1px solid var(--card-border); margin-top: 15px;">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="nb-card mb-3">
                ...
                <div class="nb-card-body" style="max-height: 290px; overflow-y: auto; padding: 12px;">
